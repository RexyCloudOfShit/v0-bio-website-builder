...
export default function HomePage() {
  ...
  const [loadingButton, setLoadingButton] = useState<"signup" | "login" | null>(null)

  const handleNavigation = (path: string, button: "signup" | "login") => {
        ...
        <div className="text-center max-w-3xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center mb-6">
            <Button
              ...
              className="text-base px-8 py-5 bg-white text-black hover:bg-white/90 disabled:opacity-70"
            >
            ...
            <Button
              ...
              disabled={loadingButton !== null}
              className="text-base px-8 py-5 bg-transparent border-white/20 hover:bg-white/10 disabled:opacity-70"
            >
              {loadingButton === "login" ? (
                <span className="flex items-center gap-2">
